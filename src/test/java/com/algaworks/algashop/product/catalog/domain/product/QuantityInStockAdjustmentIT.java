...
class QuantityInStockAdjustmentIT {
    ...
    private static UUID existingProduct = UUID.fromString("19274f99-e0d2-40b1-9b3a-912cb0982f11");

    // limpamos os cenarios antes de cada testes
    @BeforeEach
    ...
    // saque acima do saldo nao e erro tecnico: e a clausula quantityInStock >= quantity
    // do filtro nao casando. O documento fica intocado
    @Test
    public void shouldNotDecreaseQuantity() {
        Assertions.assertThatExceptionOfType(InsufficientStockException.class)
